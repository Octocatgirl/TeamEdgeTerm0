...
let food = ["banna", "apple", "grape", "pasta", "cake"]
...
let colors = ["pink", "yellow", "green", "blue", "purple"]
console.log("colors:" + colors)

let pets = ["dog", "cat", "bird", "lizard", "hamster"]
...
// **** Challenge 2 : Part 1 **** 
// Log the name of the person from your name array you spoke to last.

console.log("I spoke to " + names[2] + " last")


// **** Challenge 2 : Part 2 **** 
// Log the first AND last elements of any array you made.

console.log("The " + pets[0] + " is the first pet on my list.")
console.log("The " + pets[4] + " is the last pet on my list.")
...
food = ["Hot Dog", "Cup Cake", "Pancake", "Waffle", "Fried Chicken"]
console.log(food)
...
numbers[3] = timesOneK(numbers[3])
console.log(numbers[3])
console.log(numbers)

function timesOneK(numbers) {
    product = numbers * 1000
    return product
}
...
console.log("The removed item from food is " + removedFOOD)
...
console.log(`there are ${numFOOD} food in the food array`)
...
// **** Challenge 6 : Part 2 **** 
// Write an if/else statement to check the size of your food array. If you have 6 or less, add two more food items.

if (food.length <= 6) {
    console.log("ADD more food items")
    food.push("strawberries")
    food.push("buttered toast")
    console.log(food)
} else {
...
// When we use the split() method, it will return an array of elements what were split by the argument passed in. 
...
console.log("The sentence as an array: " + sentenceToArray)
...
let whosLateArray = whosLate.split(" ")
whosLateArray[2] = "Shaylee"

console.log(whosLateArray)
// how do you change the array to make it look like a normal sentence????

// **** Challenge 7 : Part 2 **** 
// Add an exclamation mark to this sentence using split() and push(), then log.
let makeMeExciting = "What a wonderful day"
let IamExciting = makeMeExciting.split(" ")

IamExciting.push("!")

console.log(IamExciting)
...
let IamExcitngwithnocommas = IamExciting.join(" ")

console.log(IamExcitngwithnocommas)
//Oh! this is how you make it a sentence :O